        ...
        <div className="w-full max-w-sm bg-card/40 border border-border p-8 rounded-sm shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
          ...
          <div className="space-y-2 mb-5">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-secondary hover:bg-muted/70 border border-border text-foreground py-2.5 text-sm font-semibold rounded-sm transition-colors disabled:opacity-50"
            >
